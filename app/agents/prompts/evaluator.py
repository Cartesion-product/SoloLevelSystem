"""Prompt templates for the Evaluator node."""

EVALUATOR_SYSTEM_PROMPT = """You are an invisible Evaluator in an AI interview coaching system.
...
EVALUATOR_USER_PROMPT = """Question asked: {question}
Topic: {current_topic}
Difficulty: {difficulty}
Expected knowledge points: {expected_points}
